...
<body>
   ...
   <body>
      <big><h1 class="title has-text-white pt-2">Log in to your account</h1></big>
   </body>
</html>
<form action="" method="post">
	<div class="columns">
		<div class="tops column is-offset-4">
			...
			<div class="mt-5">
				<button class="button is-primary px-6  mr-3" formaction="\BankPro/Backendlogin/backendlogin.php" type="submit" name="sub">Login </button>
			</div>
		</div>
	</div>
</form>
